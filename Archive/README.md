...
![transformers](https://img.shields.io/badge/Transformers-4.45+-yellow.svg)
![peft](https://img.shields.io/badge/PEFT-0.11+-green.svg)
...
- [Configuration](#configuration)
  ...
  - [GRPO Settings](#grpo-settings)
- [Training Strategy](#training-strategy)
  - [Parameter Efficiency](#parameter-efficiency)
  - [Reward System Architecture](#reward-system-architecture)
...
git clone https://github.com/your-Akmeos/bnpp-grpo.git
cd bnpp-grpoe
...
python train.py   --samples 128   --max-steps 200   --new-tokens 24   --temperature 0.8   --output_dir "outputs/custom-run"   --log_dir "logs/custom-run"   --seed 42
```
...
> **Note:** This project was developed under specific technical constraints (**16GB VRAM**, **≤ 4-hour training**) for a technical evaluation. Production deployments may require additional optimization and validation.
